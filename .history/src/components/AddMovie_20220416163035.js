...
const AddMovie = () => {
    ...
    const saveMovie = (e) => {
        e.preventDefault();
        const movie = { language, title, price, id };
        if (id) {
            //update records
    ...
    return (
        <div className="container">
            ...
            <form>
                ...
                <div>
                    <Link className="btn btn-warning" to="/movies">Back</Link> <button className="btn btn-primary" onClick={(e) => saveMovie(e)}>Save</button>
                </div>
            </form>
            <hr />
