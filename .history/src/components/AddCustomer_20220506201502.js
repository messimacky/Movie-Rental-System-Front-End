...
const AddCustomer = () => {
    ...
    const saveCustomer = (e) => {
        e.preventDefault();
        const customer = { id, firstName, lastName, username, phone, address, email, creationDate, createdBy, lastUpdatedBy, lastUpdatedDate };
        if (id) {
            //update records
        ...
        if (id) {
            customerService.get(id)
                .then(customer => {
                    ...
                    // setLastUpdatedBy(customer.data.lastUpdatedBy);
