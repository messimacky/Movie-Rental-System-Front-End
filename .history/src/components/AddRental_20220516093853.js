...
const AddRental = () => {
    ...
    const saveRental = (e) => {
        e.preventDefault();
        const rental = { customerId, rentalDate, isReturned, rentalExpiry, totalCost, creationDate, createdBy, lastModifiedBy, lastModifiedDate };
            ...
            <form>
                ...
                <div>
                    <input
                        type="checkbox"
                        checked={isReturned}
                        onChange={e => setIsReturned(e.target.isReturned)}
                    />
                </div>
