    ...
    useEffect(() => {
        if (id) {
            rentalService.get(id)
                .then(rental => {
                    setLanguage(rental.data.member_id);
                    setTitle(rental.data.rental_date);
                    setPrice(rental.data.rental_expiry);
                    setCreatedBy(rental.date.total_cost);
                    setCreatedDate(rental.data.created_by);
                    setUpdateddBy(rental.data.created_date);
                    setUpdatedDate(rental.data.updated_by);
