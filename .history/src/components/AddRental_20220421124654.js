...
const AddRental = () => {
    ...
    const SaveRental = (e) => {
        e.preventDefault();
        const rental = { member_id, rental_date, rental_expiry, total_cost, created_date, created_by, updated_by, updated_date };
        if (id) {
            //update records
        ...
        if (id) {
            rentalService.get(id)
                .then(rental => {
                    ...
                    setCreatedBy(rental.date.created_by);
                    setCreatedDate(rental.data.created_date);
                    setUpdateddBy(rental.data.updated_by);
