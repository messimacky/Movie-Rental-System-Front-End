...
const AddMovie = () => {
    ...
    const saveMovie = (e) => {
        e.preventDefault();
        const movie = { genre, movieId, language, title, price, creationDate, createdBy, lastModifiedBy, lastModifiedDate };
        if (movieId) {
            //update records
        ...
        if (id) {
            movieService.get(movieId)
                .then(movie => {
                    ...
                    setCreationDate(movie.data.creationDate);
                    setLastModifiedBy(movie.data.lastModifiedBy);
                    setLastModifiedDate(movie.data.lastModifiedDate);
