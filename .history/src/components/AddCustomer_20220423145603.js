...
const AddCustomer = () => {
    ...
    const saveCustomer = (e) => {
        e.preventDefault();
        const customer = { firstName, lastName, username, phone, address, email, createdDate, createdBy, updatedBy, updatedDate };
        if (id) {
            //update records
    ...
    useEffect(() => {
        if (id) {
            customerService.get(id)
                .then(customer => {
                    setFirstname(customer.data.firsName);
                    ...
                    setUpdatedDate(customer.data.updateDate);
